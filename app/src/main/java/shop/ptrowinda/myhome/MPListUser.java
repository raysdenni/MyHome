...
public class MPListUser {
    ...
    public MPListUser(String nama_lengkap, String password, String username, String bio, String email_address, String level, int user_balance, String url_photo_profile) {
